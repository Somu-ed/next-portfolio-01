...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, PinterestIcon, SunIcon, MoonIcon } from '@/components/icons'
    ...
    >
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
          ...
          <motion.a href="https://www.linkedin.com/in/s-satpathy/" target={'_blank'}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className='w-6 mx-3'
          >
          ...
          <motion.a href="https://github.com/Somu-ed" target={'_blank'}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className='w-6 mx-3'
          >
